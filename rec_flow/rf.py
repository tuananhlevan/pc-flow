...
if __name__ == "__main__":
    ...
    wandb.init(
        entity="anh-lvt2416657-hanoi-university-of-science-and-technology",
        project=f"rf_{dataset_name}",
    )
    ...
    for epoch in range(1, 101):
        ...
        with torch.no_grad():
            ...
            os.makedirs(f"contents/epoch_{epoch}", exist_ok=True)

            gif[0].save(
                f"contents/epoch_{epoch}/sample.gif",
                save_all=True,
                append_images=gif[1:],
                duration=100,
                loop=0,
            ...
            last_img = gif[-1]
            last_img.save(f"contents/epoch_{epoch}/sample_last.png")
            
            torch.save(rf.model.state_dict(), f"contents/epoch_{epoch}/weight.pt")
